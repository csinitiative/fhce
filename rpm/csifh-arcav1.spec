...
%define instdir /opt/csi/fh/arca
%define makedir feeds/arca/multicast/v1
%define plugdir plugins/sample/arca
...
summary: ArcaBook Multicast v1 feed handler component of the CSI FH feed handler suite
name: csifh-arcav1
...
This package contains the ArcaBook Multicast v1 feed handler(s).
...
%post
ln -sf %{instdir}/bin/fharca_v1 %{instdir}/bin/fharca
